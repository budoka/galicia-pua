        ...
        },
        {
          ...
          options: {
            ...
            modifyVars: {
              ...
              'table-row-hover-bg': '#f00',*/
              //hack: `true; @import "../src/overrides.less";`,
            },
              ...
              use: getStyleLoaders(
                {
                  ...
                  //modules: { getLocalIdent: '[name]_[local]_[hash:base64]' },
                },
                'less-loader',
              ),
            },
    ...
    plugins: [
      ...
      useTypeScript &&
        new ForkTsCheckerWebpackPlugin({
          ...
          reportFiles: ['**', '!**/__tests__/**', '!**/?(*.)(spec|test).*', '!**/setup-proxy.*', '!**/setup-tests.*'],
          silent: true,
